...
function M:SpawnWeapon()
	...
	local NewWeapon = World:SpawnActorEx(WeaponClass, self:GetTransform(), nil, "Weapon.BP_DefaultWeapon_C", sp)
	UEPrint("[PlayerCharacter]SpawnWeapon, WeaponClass:", WeaponClass, ",NewWeapon=", NewWeapon)
	return NewWeapon
end
...
function M:OnCustomHit(HitComp, OtherActor, OtherComp, NormalImpulse, Hit)
	UEPrint("[PlayerCharacter]OnCustomHit, HitComp:", HitComp:GetName(), ",OtherActor:", OtherActor:GetName(), ",OtherComp:", OtherComp:GetName())
end
